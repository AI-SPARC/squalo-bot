...
class MPC:
    ...
    def __init__(self, mass, position, v_min, v_max, N, N_c, Ts):
        """ MPC-ORCA controller instance
        
        :param mass: Prototype mass
        :type mass: int
        ...
        Bd = sparse.csc_matrix([
            [(Ts**2)/2*mass, (Ts**2)/2*mass  ],
            [((Ts**2)*0.2)/(2*mass*(0.3**2) + 3.234), -((Ts**2)*0.2)/(2*mass*(0.3**2) + 3.234)],
            [Ts/mass + (0.3*0.2*(Ts**2))/(2*mass*(0.3**2) + 3.234), Ts/mass - (0.3*0.2*(Ts**2))/(2*mass*(0.3**2) + 3.234)],
            [(Ts*0.2)/(mass*(0.3**2) + 3.234), -(Ts*0.2)/(mass*(0.3**2) + 3.234)]
        ])
        ...
        Q_0 = sparse.diags([1.0, 1.0, 0.5, 0.5])
